...
//
// The set of units is closed by an unexported method, so the only way a caller
// reaches this is by assigning a nil. It is otherwise here for the reason
// [UnknownItemError] is: a unit added to the package and not added to the
// writer is refused rather than written as nothing.
